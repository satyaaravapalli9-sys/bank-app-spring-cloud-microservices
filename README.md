...
This project demonstrates the architectural evolution of a banking application, progressing from a monolithic structure to a fully distributed microservices ecosystem using Spring Cloud.
...
## Stage 2 - Splitted monolithic application into multiple unique functionality application Microservice
In this stage whole application is splitted into different microservices on the basis of unique functionality using Spring-cloud.
...
In this stage multiple microservices has a central configuration source as github repository where all the configuration is stored and properties are served to microservices using Spring cloud Config Server with all the microservices act as Config Client.
...
For zipkin, we can use a self-contained jar file for running zipkin server using command:
curl -sSL https://zipkin.io/quickstart.sh | bash -s
and then:
java -jar zipkin.jar

## About the Developer
This project is maintained by Satya Kumar, a Java Full Stack Developer specializing in building and supporting production systems using Java, Spring Boot, React, AWS, and Kubernetes. With over 5 years of experience, Satya focuses on microservices, distributed systems, and Site Reliability Engineering (SRE) to improve system stability, performance, and deployment reliability.

Contact Information:
- Name: Satya Kumar
- Title: Java Full Stack Developer | AWS | AI | SRE
